...
class PhoneNumberSendScreen extends StatefulWidget {
  const PhoneNumberSendScreen({super.key});

  @override
  State<PhoneNumberSendScreen> createState() => _PhoneNumberSendScreenState();
}

class _PhoneNumberSendScreenState extends State<PhoneNumberSendScreen> {
  @override
  void initState() {
    super.initState();
    // playVideo(init: true);
